...
var Admin = class extends Remote {
    ...
    /**
     * Construct a Administrator object with the given url and opts. A Administrator object
     * encapsulates the properties of an endorsing Administrator and the interactions with it
     * via the grpc service API. Administrator objects are used by the {@link Client} objects to
     * get peer status, etc.
     *
     * @param {string} url - The URL with format of "grpc(s)://host:port".
     * @param {ConnectionOpts} opts - The options for the connection to the Administrator.
     * @returns {Administrator} The Administrator instance.
     */
