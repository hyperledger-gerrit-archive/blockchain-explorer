...
describe('Explorer dashboard', () => {
	...
	describe('peers', () => {
		...
		it('should have the correct URL for each peer', () => {
			...
			peerUrlList.sort();
			peerUrlList[0].getText().should.be.equal('peer1.org1.example.com');
			peerUrlList[1].getText().should.be.equal('peer0.org1.example.com');
			peerUrlList[2].getText().should.be.equal('peer1.org2.example.com');
			peerUrlList[3].getText().should.be.equal('peer0.org2.example.com');
		});
	});
